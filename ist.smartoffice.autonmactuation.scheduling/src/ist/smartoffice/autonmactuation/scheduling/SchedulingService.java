package ist.smartoffice.autonmactuation.scheduling;
...
public class SchedulingService implements IDatapointConnectivityService {

	@Override
	public String getImplementationName() {
		return SchedulingService.class.getName();
	}
