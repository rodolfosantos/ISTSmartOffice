...
/**
 * Wrapper of a {@link IDatapointConnectivityService} that creates a REST/JSON interface
 * to use the provided services, and registers itself as a datapoint listener in the
 * service.
