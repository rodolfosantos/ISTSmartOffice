...
import ist.smartoffice.deviceconnectivity.DatapointMetadata.AccessType;
import ist.smartoffice.deviceconnectivity.DatapointMetadata.Datatype;
import ist.smartoffice.deviceconnectivity.DatapointMetadata.MetadataBuilder;
	...
	public static Map<DatapointAddress, DatapointMetadata> loadDatapointsConfigs() {
		...
		if (datapointSettings != null) {
			Iterator<Entry<String, DatapointMetadata>> it = datapointSettings
					.entrySet().iterator();
			while (it.hasNext()) {
				Map.Entry<java.lang.String, ist.smartoffice.deviceconnectivity.DatapointMetadata> entry = (Map.Entry<java.lang.String, ist.smartoffice.deviceconnectivity.DatapointMetadata>) it
						.next();
